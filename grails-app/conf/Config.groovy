...
environments {
    development {
		...
		grails.mongo.databaseName = "AnandGarments"
		grails.mongo.host = "localhost"
		grails.mongo.username = "anand"
		grails.mongo.password = "anand"
...
file.extensions.video = ['avi','mp4']
file.extensions.text = ['txt']
file.extensions.doc = ['doc','docx']

//set lastLoginDate of user
